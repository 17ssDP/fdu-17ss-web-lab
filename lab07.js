let addTable = document.getElementsByClassName("add_table")[0];
let showTable = document.getElementsByClassName("show_table")[0];
let selectedBox = document.getElementsByClassName("add")[0];
let showedTable = document.getElementsByClassName("show")[0];
let commit = document.getElementsByClassName("button")[0];
let tables = [];
let inputs = [];
let input_text;
...
commit.addEventListener("click", function() {
  switch (selectedBox.selectedIndex) {
    ...
    case 3:
      ...
      for (var i = selectedTableTr.childNodes.length - 1; i > 0; i--) {
